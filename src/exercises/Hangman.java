...
public class Hangman extends KeyAdapter {
	...
	public void keyTyped(KeyEvent arg0) {
		...
		if (Wins()) {
			int confirmation = JOptionPane.showConfirmDialog(panel, "You won! I dare you to play more!", puzzle,
		...
		if (lives == 0 && !Wins()) {
			JOptionPane.showMessageDialog(panel, "You lose, you are to be hanged!");
			System.exit(0);
		}
	}
